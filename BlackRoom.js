...
eval( callHeaderFile( "/Git/BlackRoom/header/makeToast.js" ) );


//리소스 파일 다운로드 소스

eval( callHeaderFile( "/Git/BlackRoom/header/download.js" ) );


//스크, 모드, 에드온 적용시 경고하는 소스

eval( callHeaderFile( "/Git/BlackRoom/header/getEnabledPatches.js" ) );


//채팅관련 모든 함수

eval( callHeaderFile( "/Git/BlackRoom/header/chat.js" ) );



//이펙트(스크린 흔들기, 진동, 스크린 어둡게하기 등) 관련 모든 함수

eval( callHeaderFile( "/Git/BlackRoom/header/effect.js" ) );
